    ...
    public class RecommendationsApiWrapper
    {
        ...
        public ModelInfo CreateModel(string modelName, string description = null)
        {
            ...
            var jsonModelRequest = JsonConvert.SerializeObject(modelRequestInfo);
            var response = _httpClient.PostAsync(uri, new StringContent(jsonModelRequest, Encoding.UTF8, "application/json")).Result;
        ...
        public long BuildModel(string modelId, BuildRequestInfo buildRequestInfo, out string operationLocationHeader)
        {
            ...
            var buildRequestInfoJson = JsonConvert.SerializeObject(buildRequestInfo);
            var response = _httpClient.PostAsync(uri, new StringContent(buildRequestInfoJson, Encoding.UTF8, "application/json")).Result;
